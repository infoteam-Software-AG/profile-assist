...
This is documented here: `src/main/docs/_includes/concept/persona-folder-structure.puml`
...
This ensures that the nullability of types is clear to both developers and tools,
improving code safety, readability, and consistency across the system.
