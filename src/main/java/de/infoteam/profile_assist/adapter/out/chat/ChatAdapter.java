package de.infoteam.profile_assist.adapter.out.chat;
...
@Service
public class ChatAdapter implements PromptForSimpleQuestionPort, PromptForPersonaOptimizationPort, PromptForTestPersonaPort {
