...
class SpringAiOptimizeProjectDescriptionUseCaseTest {
  ...
  @InjectMocks
  SpringAiOptimizeProjectDescriptionUseCase springAiOptimizeProjectDescriptionUseCase;
  ...
  void testSearchMissingProjectSkills() {
    when(springAiClient.sendPrompt(eq(String.class), anyString(), anyString()))
      .thenReturn(new OptimizationResultImpl<>("JavaScript, TypeScript, Java, C++, SQL"));
    ...
    then(actual.result()).isEqualTo("JavaScript, TypeScript, Java, C++, SQL");
  }
  ...
  private static Persona.PersonaBuilder personaBuilder() {
    return Persona.builder()
      ...
      .skills(new Skills(new ArrayList<>(),new ArrayList<>(),new ArrayList<>(),new ArrayList<>(),new ArrayList<>(),new ArrayList<>(),new ArrayList<>()))
