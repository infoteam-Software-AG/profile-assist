...
import de.infoteam.profile_assist.domain.usecase.ChatService;
...
public class ChatServiceIT {
    ...
    public void askSimpleQuestion_shouldReturnAnAnswer() {
        // Arrange
        String question = "Write a playful haiku about morning coffee following the traditional 5-7-5 syllable structure.";
    ...
    @Test
    public void askForPersonaOptimization_shouldUpdateUpdateTimestamp() throws JsonProcessingException {
        // Arrange
        Persona unoptimizedPersona = chatService.askToCreateTestPersona();
        log.info("Unoptimized persona: {}", this.objectMapper.writeValueAsString(unoptimizedPersona));
